...
import type { Language } from "../../../../lib/fetchArticles";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (typeof body.pairId !== "string" || !body.pairId) return NextResponse.json({ success: false, error: "pairId is required" }, { status: 400 });
    const expectedLanguage = body.expectedLanguage === "HINDI" || body.expectedLanguage === "ENGLISH" ? body.expectedLanguage as Language : undefined;
